...
extension Config {
    ...
    static let schema = """
    {
      ...
      "title": "syures config",
      "description": "Generated by syures on launch. Edits here are overwritten. Also validates a plugin manifest: plugins/<name>/plugin.jsonc is an array of commands.",
      "oneOf": [
        { "$ref": "#/$defs/config" },
...
extension Config {
    ...
    [
      // A manifest is an array of commands — the same shape a `menu` script prints.
